    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="pt-2 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-secondary/5 border border-secondary/20 p-5 rounded-xl h-[104px] flex flex-col justify-center">
        ...
        <div className="w-full bg-secondary/5 border border-secondary/20 rounded-2xl p-6">
          <div className="flex justify-between items-center mb-6 border-b border-secondary/10 pb-4">
            ...
            <div className="h-8 w-24 bg-secondary/20 rounded-md"></div>
          </div>
